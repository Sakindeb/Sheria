    ...
    <div className={styles.fullHeight}>
        ...
        <section className={styles.introSection}>
          ...
          <div>
            <button className={styles.getStartedButton}>
              <Link to="/username">Getting Started</Link>
            </button>
          </div>
        </section>
        ...
        <section className={styles.row}>
          <div className={styles.column}>
            ...
            <p>
              ...
              one, our business services are tailored to meet your specific
              needs.
            </p>
          </div>
          <div className={styles.column}>
            ...
            <p>
              Planning for the future is crucial, and our personal legal
              services cover a broad spectrum of needs providing expert advice
              and assistance in creating wills and trusts, helping you secure
              your family's financial well-being and manage your estate
              efficiently.{" "}
            </p>
          </div>
          <div className={styles.column}>
            ...
            <p>
              Legal challenges can arise unexpectedly, and having access to
              reliable resources is essential. Our platform offers you the
              convenience of accessing legal forms that are commonly required,
      ...
      <section className={styles.teamSection}>
        ...
        <footer className={styles.footer}>
          ...
          <p>
            Legal Savannah offers access to independent advocates and
            user-friendly self-service resources. We operate independently and
            do not offer legal counsel.
          </p>
        </footer>
      </div>
    </div>
